        ...
        <div className="flex-1 h-full relative flex justify-between box-border">
          ...
          <div className="flex w-full relative pointer-events-none justify-center">
            <div className="hidden max-md:flex justify-between w-full fixed top-1/6 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[1010] px-2 pointer-events-auto">
              <div className="flex flex-row gap-3 w-auto mx-auto  overflow-x-auto py-2 px-3 bg-[#1a131fcc] backdrop-blur-md rounded-xl border border-[#3b3340] shadow-xl">
                {panels.map((item) => {
            ...
            {/* main panel (About Me) */}
            <DraggableDiv className="flex relative md:min-w-xl max-md:min-w-104 max-sm:min-w-[20rem] md:mb-35 self-end pointer-events-none">
              <motion.section
                key="about-me"
